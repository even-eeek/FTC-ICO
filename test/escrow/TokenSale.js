...
const BENIFICIARY_ACCOUNT = '0x6B5194F6F93952025a08456050561b91f27BD6e3';
const UNSOLD_TOKENS_ACCOUNT = '0x6B99a0fBf3057578a94b3ec4FE108cc815C95aB5';
const MARKETING_ACCOUNT = '0xcA60885957EF5Be9c8B91Bc6baD839aF94A2E86D';
const TEAM_MEMBER_1_ACCOUNT = '0x9c70368FDa6a17FAAc00b771045D3061757728F7';
const TEAM_MEMBER_2_ACCOUNT = '0x29796979445d187B731B3354209135E326213159';
const TEAM_MEMBER_3_ACCOUNT = '0xd25716a7625E38f90a97531EAda7328E79616ce1';
const TEAM_MEMBER_4_ACCOUNT = '0xdc6b1630AdB5Beea8606e0a471bd5524317C3372';
const FCHAIN_FOUNDATION_ACCOUNT = '0x04dC3eEf55679513A85BEF1d630B4d541e7cFe04';
const FCHAIN_COMPANY_ACCOUNT = '0x669972Ae2BCd86280e6bCefe9416dB4F3AA6219E';
...
const FCHAIN_FOUNDATION_SHARE = '200000000000000000000000000'; // 200m * 10^18
const FCHAIN_COMPANY_SHARE    = '200000000000000000000000000'; // 200m * 10^18
...
let getBalanceByTokenSale = async (tokenSale, account) => {
    ...
    await token.balanceOf(account).then(res => {

      console.log("===========================================================================================")
      console.log("account")
      console.log(account)
      console.log("token.balanceOf(account")
...
contract('TokenSale', accounts => {
    ...
    it("should have create per first/other window values after calling distributeShares (without bulk purchasers)", async () => {
        ...
        assert.equal(
            new BigNumber(TOTAL_SUPPLY)
                .minus(new BigNumber(FCHAIN_FOUNDATION_SHARE))
                .minus(new BigNumber(FCHAIN_COMPANY_SHARE))
    ...
    it("should have proper distribution of tokens after calling distributeShares", async () => {
        ...
        assert.equal(
            new BigNumber(FCHAIN_COMPANY_SHARE).plus(FCHAIN_FOUNDATION_SHARE).toString(10),
        ...
        let companyShare = await escrow.shares(FCHAIN_COMPANY_ACCOUNT);
    ...
    it("should have correct wallets set up", async () => {
        ...
        assert.equal(FCHAIN_FOUNDATION_ACCOUNT, await tokenSale.wallets(0));
        assert.equal(FCHAIN_COMPANY_ACCOUNT, await tokenSale.wallets(1));
